<!-- This files exists simply to create an array of all of the FAQs because it was too tedious to copy and paste every questions and answers manually into the page. This data is called by the faqQuestions function
I think it makes it more modular and easy to edit
-->
<?php 

$faq = array("Q) Why do exterior fixture bulbs burn out so often?" =>
...
"A) Except in the case of ground fault interrupters, which are susceptible to moisture and/or weather conditions, fuses and circuit breakers should not trip. Check to see if some type of plugged in appliance is causing the problem. If this happens regularly, itâ€™s time upgrade the load-bearing capacity of your service panel.",


"Q) What causes the lights in my house to flicker?" =>
"A) Though it could be that your service panel is not equipped to handle the load of your appliances, we have found that in the Waukegan area, itâ€™s often old or improperly installed wiring that is to blame. DO NOT RISK A FIRE. Call us today to find the problem for you.",
