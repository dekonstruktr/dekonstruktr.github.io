<?php include("includes/head.inc.php"); ?>
    ...
    <section>
        <article>
            <header>
               <img id="red-logo" src="./images/logo-red.svg"><h1>H1 Heading</h1>
                <h2>H2 Subheading</h2>
            </header>
            <img id="img1"  class="images" src="./images/tool-on-instructions.jpg" alt="tool on instructions image">
    ...
    <section>
        <article>
            ...
            <img id="tree2" class="images" src="images/tree2.jpg">
        </article>
    </section>
    <!--End section THREE-->
